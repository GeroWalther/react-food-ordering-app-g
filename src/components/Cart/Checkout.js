...
const isNotEmpty = (value) => value.trim().length !== "";
...
const Checkout = (props) => {
  ...
  const postalCodeControleClasses = `${classes.control} ${
  ...
  return (
    <form className={classes.form} onSubmit={confirmHandler}>
      ...
      <div className={postalCodeControleClasses}>
        <label htmlFor="postal">Postal Code</label>
        <input type="text" id="postal" ref={postalCodeInputRef} />
        {!formInputsValidity.postalCode && (
          <p>Please enter a valid postal code! (5 charackters long)</p>
        )}
      </div>
